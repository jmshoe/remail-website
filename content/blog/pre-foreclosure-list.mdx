...
Use our [free ROAS calculator](/direct-mail-roas-calculator) to see how these response rates translate into ROI for your campaigns. And if you're testing different mail pieces, our [sample size calculator](/direct-mail-sample-size-calculator) can help you determine the minimum volume needed for statistically valid results.
