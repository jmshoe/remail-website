...
const footerNavigation = {
  solutions: [
    { name: 'Direct Mail Automation', href: '/services' },
    { name: 'Skip Tracing', href: '/services#skip-tracing' },
    { name: 'List Building', href: '/services#lists' },
    { name: 'Template Designer', href: '/services#templates' },
  ],
  audiences: [
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-8">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-white">REmail</span>
            </Link>
            <p className="text-sm leading-6">
              Automate your direct mail campaigns. Built for real estate investors
              who want more deals with less effort.
            </p>
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0">
                <h3 className="text-sm font-semibold leading-6 text-white">Audiences</h3>
                <ul role="list" className="mt-6 space-y-4">
        ...
        <div className="mt-16 border-t border-slate-700 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-slate-500">
            &copy; {new Date().getFullYear()} REmail. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
